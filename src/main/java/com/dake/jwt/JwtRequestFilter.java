...
public class JwtRequestFilter extends OncePerRequestFilter{
	...
	//1. we look at the autho header if there is token we get it and use it. no need to create token	
	//2. if there is no token if it's null but username is not null
